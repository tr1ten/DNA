...
void testcase() {
  ...
  ll res = 0;
  res = max(res,sms[oo[0]]+sms[oo[1]]+sms[oo[2]] - 2*(mn[oo[1]]  + mn[oo[2]] + mn[oo[0]] - max(mn[oo[1]],max(mn[oo[2]], mn[oo[0]])) )  ) ;
  res = max(res,sms[oo[0]]+sms[oo[1]]+sms[oo[2]] - 2*min(sms[oo[0]],min(sms[oo[1]],sms[oo[2]]))) ;
